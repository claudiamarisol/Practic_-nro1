...
echo "usar un solo metodo para GET y otro para SET, crear metodo constructor. <br>";
?>
<?php
class Estudiante
{
...
//Usamos __SET para asignar
$boris->__SET('Nombre','Boris Cristhian');
$boris->__SET('Edad',20);
$boris->__SET('Altura',1.50);
//Usamos __GET para recuperar algun dato
echo $boris->__GET('Nombre')."<br>";
echo $boris->__GET('Edad')."<br>";
echo $boris->__GET('Altura')."<br>";
//Usamos metodo mostrar para mostrar lo datos
echo $boris->Mostrar();

echo "<h3>Estudiante 2</h3>";
$claudia_marisol = new Estudiante();
$claudia_marisol->__SET('Nombre','Claudia Marisol');
...
$jhessica->__SET('Nombre','Jhessica');
$jhessica->__SET('Edad',19);
$jhessica->__SET('Altura',1.50);
echo $jhessica->__GET('Nombre')."<br>";
echo $jhessica->__GET('Edad')."<br>";
echo $jhessica->__GET('Altura')."<br>";
...
$juan_paul->__SET('Nombre','Juan Paul');
