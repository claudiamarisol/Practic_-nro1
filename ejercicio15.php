...
echo "POO, Crear una Clase Persona y usar el metodo constructor.<br>";
?>
<?php
class Persona
{
...
$claudia_marisol = new Persona('Claudia Marisol', 19, 1.50);
...
$erika = new Persona('Erika Amanda', 20, 1.50);
echo $erika->Mostrar();
...
$yola = new Persona('Yola', 18, 1.50);
echo $yola->Mostrar();

echo "<h3>Persona 8</h3>";
$juan_paul = new Persona('Juan Paul', 19, 1.50);
echo $juan_paul->Mostrar();

echo "<h3>Persona 9</h3>";
$rodrigo = new Persona('Rodrigo', 22, 1.50);
echo $rodrigo->Mostrar();

echo "<h3>Persona 10</h3>";
$luz_natalia = new Persona('Luz Natalia', 18, 1.50);
echo $luz_natalia->Mostrar();

echo "<h3>Persona 11</h3>";
$juan_ronaldo = new Persona('Juan Ronaldo', 19, 1.50);
echo $juan_ronaldo->Mostrar();

echo "<h3>Persona 12</h3>";
$rosse_mary = new Persona('Rosse Mary', 19, 1.50);
